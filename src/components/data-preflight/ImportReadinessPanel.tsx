...
export function ImportReadinessPanel({
  ...
  return (
    <section className="rounded-2xl border border-blue-400/20 bg-blue-500/[0.08] p-4 shadow-2xl shadow-blue-950/30 backdrop-blur">
      <div className="grid gap-4 xl:grid-cols-[1fr_0.85fr]">
        <div>
          ...
          <p className="mt-1.5 max-w-2xl text-sm leading-6 text-blue-100/80">
            {importReadinessMessage}
          </p>
        ...
        <div className="rounded-2xl border border-white/10 bg-slate-950/35 p-4">
          ...
          {!canExport && (
            <div className="mt-3 rounded-xl border border-yellow-400/25 bg-yellow-400/10 p-2.5 text-xs leading-5 text-yellow-100">
          ...
          <div className="mt-3 flex flex-col gap-2">
            <button
              ...
              disabled={!canExport}
              className="rounded-xl bg-slate-100 px-4 py-2 text-sm font-semibold text-slate-950 transition hover:bg-white disabled:cursor-not-allowed disabled:opacity-40"
            >
              Download clean CSV
            </button>
            ...
            <button
              ...
              className="rounded-xl border border-white/10 bg-white/[0.04] px-4 py-2 text-sm font-medium text-slate-100 transition hover:border-white/20 hover:bg-white/[0.08] disabled:cursor-not-allowed disabled:opacity-40"
            >
...
function StatusPill({
  ...
  const toneClasses = {
    warning: "border-yellow-400/20 bg-yellow-400/[0.07] text-yellow-100/90",
    danger: "border-red-400/20 bg-red-400/[0.07] text-red-100/90",
    success: "border-emerald-400/20 bg-emerald-400/[0.07] text-emerald-100/90",
    info: "border-violet-400/18 bg-violet-400/[0.06] text-violet-100/85",
  };
